...
> 当前状态：v2.3 全功能已完成（含历史曲线、分布式拨测、节点详情弹窗、告警通知、备份/恢复、2FA、审计日志、主控自监控、节点 Tag、主题切换、公开只读页、移动端响应式）
...
- ✅ 主题系统（深色/浅色/蓝色） **v2.3 完成**
- ❌ OpenAPI 二次开发接口
- ❌ Prometheus metrics 导出
- ✅ 移动端响应式优化（双断点） **v2.3 完成**
- ✅ Docker 镜像（ghcr.io/merlin-node/mote，多架构）
- ❌ Webhook / Email / Bark / 钉钉 通知渠道
- ✅ Cookie/JWT 登录 + 修改密码 + 2FA **v2.2 完成**
...
*v2.3 设计稿 · 2026-05 · 重点：分布式拨测 + 节点详情弹窗 + UI 全面升级*
